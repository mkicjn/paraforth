...
\ TODO Since the calling convention will be different in v2, it may be challenging to bootstrap without wordlists.
...
\ TODO Redefine :! for v2 and define {, }, and INLINE inside the binary (which means redefining MOVE, etc.)
...
\ TODO The references created by POSTPONE won't work in the target
