...
DEF INC  REX.W, $ FF C, $ 0 $ 3 MODR/M,  EXIT
DEF DEC  REX.W, $ FF C, $ 1 $ 3 MODR/M,  EXIT
...
DEF MOVE DOCOL  CONTEXT>R  RDI RAX MOV DROP  RCX RAX MOV DROP  RSI RAX MOV  REP MOVSB
                RAX RDI MOV  R>CONTEXT  RDI RAX MOV  DROP  EXIT
